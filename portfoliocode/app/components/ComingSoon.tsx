...
const ComingSoon: React.FC<ComingSoonProps> = ({ isLight }) => {
    return (
        <div className={`relative h-[100vh] w-[100vw] flex items-center justify-center ${isLight ? "bg-[#F2F2F7] text-black" : "bg-black text-white"} overflow-x-hidden overflow-y-hidden`}>
